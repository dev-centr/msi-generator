...
<a href="https://docs.devcentr.org/tools/msi-generator/"><strong>Explore the docs »</strong></a><br /><br />
...
link:https://docs.devcentr.org/tools/msi-generator/[Explore the docs] ·
...
[source,bash]
----
See https://docs.devcentr.org/tools/msi-generator/ (built from docs/ by the org hub).
----
